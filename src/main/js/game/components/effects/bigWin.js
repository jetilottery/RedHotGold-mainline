define(require => {
  ...
  function setState(data) {
    ...
    // Set animation state
    _bigWin_landscape.state.setAnimation(syncTime, 'Land_bigWin_level' + data.level, doLoop);
    _bigWin_portrait.state.setAnimation(syncTime, 'Port_bigWin_level' + data.level, doLoop);
  ...
  msgBus.subscribe('Result.RollupStarted', () => particleManager({
    mode: 2,
    level: findPrizeLevel()
  }));
