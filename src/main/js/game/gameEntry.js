define(function (require) {
    ...
    const howToPlaySpineAnimations = require('game/components/effects/HowToPlaySpineAnimations');
    ...
    const multiplierGame = require('game/components/multiplier/multiplierGame');
    ...
    const text = require('game/components/utils/text');
    ...
    function gameInit() {
        ...
        prizeTable.init();
        playerSymbols.init();
        playerSymbolIndicators.init();
        lightIndicators.init();
        bonusGame.init();
        multiplierGame.init();
        buyTryAnim.init();
        ...
        howToPlaySpineAnimations.init();
        bonusLightParticles.init();

        text.fix();
        
        scenarioSymbols.init();
